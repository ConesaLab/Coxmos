...
Despite specifying an EPV of 5, we should have a maximum of 6 variables in our final survival model in relation to the number of events found in our training set. To compute our EPV, we can used the function `getEPV()` that requires the matrix X and Y as input.
