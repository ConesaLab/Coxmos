...
After this change, a total of `r coxen_model$selected_variables` variables have been selected. And a total of `r length(coxen_model$removed_variables_cox)` have been removed due to non-significant.
