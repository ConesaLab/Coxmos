...
splsicox <- function(X, Y,
  ...
  if(h==0){ #any significant individual cox model at first component
    ...
    return(splsicox_class(list(X = list("data" = if(returnData) X_norm else NA, "loadings" = NULL, "weightings" = NULL, "weightings_norm" = NULL, "W.star" = NULL, "scores" = NULL, "E" = NULL, "x.mean" = xmeans, "x.sd" = xsds),
  ...
  invisible(gc())
  return(splsicox_class(list(X = list("data" = if(returnData) X_norm else NA, "loadings" = P, "weightings" = W, "weightings_norm" = W_norm, "W.star" = W.star, "scores" = Ts, "E" = E, "x.mean" = xmeans, "x.sd" = xsds),
                            Y = list("data" = Yh, "y.mean" = ymeans, "y.sd" = ysds),
...
cv.splsicox <- function (X, Y,
  ...
  # comp_model_lst <- get_HDCOX_models(method = pkg.env$splsicox,
  #                                    lst_X_train = lst_X_train, lst_Y_train = lst_Y_train,
