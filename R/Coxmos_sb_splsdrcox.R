...
#' The function returns a Coxmos model with the attribute model as "SB.sPLS-DRCOX".
#'
...
#'
#' @return Instance of class "Coxmos" and model "sb.splscox". The class contains the following elements:
